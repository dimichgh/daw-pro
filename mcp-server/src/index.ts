...
server.registerTool(
  "track_rename",
  {
    ...
    description: "Change a track's display name.",
    inputSchema: {
...
const automationTargetSchema = z
  .discriminatedUnion("type", [
    ...
    z.object({ type: z.literal("pan") }),
    z.object({
      type: z.literal("sendLevel"),
      sendId: z
        .string()
        .min(1)
...
// `ACEStepClient: SongGenerating`. Unlike generate_lyrics/generate_song_suno/
